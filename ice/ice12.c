...
#if defined(ICE) && (FILE_ID == 12)

char ICE_DESCRIPTION[] = "ECE353: ICE 12 - UART Tx Interrupts";
...
/*  Global Variables                                                         */
/*****************************************************************************/
const char RX_MSG[] = "\033[0;32mAsynch Rx Msg <-\033[0m";
const char TX_MSG[] = "\033[0;31mAsynch Tx Msg ->\033[0m";
/*****************************************************************************/
